...
type ApplicationQuery struct {
	...
	// filter by sync status values (e.g. Synced, OutOfSync, Unknown)
	SyncStatuses []string `protobuf:"bytes,9,rep,name=syncStatuses" json:"syncStatuses,omitempty"`
	// filter by health status values (e.g. Healthy, Degraded, Progressing, Missing, Unknown)
	HealthStatuses []string `protobuf:"bytes,10,rep,name=healthStatuses" json:"healthStatuses,omitempty"`
	// filter by destination cluster server URLs or names
	Clusters []string `protobuf:"bytes,11,rep,name=clusters" json:"clusters,omitempty"`
	// filter by destination namespaces
	Namespaces []string `protobuf:"bytes,12,rep,name=namespaces" json:"namespaces,omitempty"`
	// filter by auto-sync status (Enabled, Disabled)
	AutoSyncStatuses []string `protobuf:"bytes,13,rep,name=autoSyncStatuses" json:"autoSyncStatuses,omitempty"`
	// pagination: maximum number of items to return (default 200)
	Limit *int64 `protobuf:"varint,14,opt,name=limit" json:"limit,omitempty"`
	// pagination: offset from the beginning of the filtered list
	Offset *int64 `protobuf:"varint,15,opt,name=offset" json:"offset,omitempty"`
	// filter by multiple source repository URLs
	Repos []string `protobuf:"bytes,16,rep,name=repos" json:"repos,omitempty"`
	// filter by target revision values
	TargetRevisions []string `protobuf:"bytes,17,rep,name=targetRevisions" json:"targetRevisions,omitempty"`
	// search by application name or namespace (substring match)
	Search *string `protobuf:"bytes,18,opt,name=search" json:"search,omitempty"`
	// sort field: name, createdAt, or synchronized
	SortBy *string `protobuf:"bytes,19,opt,name=sortBy" json:"sortBy,omitempty"`
	// sort order: asc or desc (default asc)
	SortOrder *string `protobuf:"bytes,20,opt,name=sortOrder" json:"sortOrder,omitempty"`
	// filter by operation status (e.g. Syncing, Sync OK, Sync failed, Sync error, Unknown)
	Operations []string `protobuf:"bytes,21,rep,name=operations" json:"operations,omitempty"`
	// filter by annotations using selector-style expressions (e.g. "key=value", "key")
	Annotations          []string `protobuf:"bytes,22,rep,name=annotations" json:"annotations,omitempty"`
...
func (m *ApplicationQuery) GetAutoSyncStatuses() []string {
	if m != nil {
		return m.AutoSyncStatuses
	}
	return nil
}
...
func (m *ApplicationQuery) GetTargetRevisions() []string {
	if m != nil {
		return m.TargetRevisions
	}
	return nil
}
...
func (m *ApplicationQuery) GetSortOrder() string {
...
func (m *ApplicationQuery) GetOperations() []string {
	if m != nil {
		return m.Operations
	}
	return nil
...
func (m *ApplicationQuery) GetAnnotations() []string {
	if m != nil {
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
func (m *ApplicationQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Annotations) > 0 {
		for iNdEx := len(m.Annotations) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintApplication(dAtA, i, uint64(len(m.Annotations[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xb2
	...
	if len(m.Operations) > 0 {
		for iNdEx := len(m.Operations) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintApplication(dAtA, i, uint64(len(m.Operations[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xaa
	...
	if m.SortOrder != nil {
		...
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.SortOrder)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
	...
	if len(m.TargetRevisions) > 0 {
		for iNdEx := len(m.TargetRevisions) - 1; iNdEx >= 0; iNdEx-- {
			...
			copy(dAtA[i:], m.TargetRevisions[iNdEx])
			i = encodeVarintApplication(dAtA, i, uint64(len(m.TargetRevisions[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x8a
	...
	if len(m.AutoSyncStatuses) > 0 {
		for iNdEx := len(m.AutoSyncStatuses) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AutoSyncStatuses[iNdEx])
			copy(dAtA[i:], m.AutoSyncStatuses[iNdEx])
			i = encodeVarintApplication(dAtA, i, uint64(len(m.AutoSyncStatuses[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
...
func (m *ApplicationQuery) Size() (n int) {
	...
	if len(m.AutoSyncStatuses) > 0 {
		for _, s := range m.AutoSyncStatuses {
			l = len(s)
			n += 1 + l + sovApplication(uint64(l))
		}
	}
	...
	if len(m.TargetRevisions) > 0 {
		for _, s := range m.TargetRevisions {
			l = len(s)
			n += 2 + l + sovApplication(uint64(l))
		}
	}
...
func (m *ApplicationQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoSyncStatuses", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoSyncStatuses = append(m.AutoSyncStatuses, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 14:
			if wireType != 0 {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetRevisions", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
